//
//  XH_search_one_ViewController.m
//  DXRacerAFE
//
...
@interface XH_search_one_ViewController ()<UITextFieldDelegate>

@end

@implementation XH_search_one_ViewController
...
- (IBAction)clicksearch:(id)sender {
    ...
    XH_01_ViewController *ploi = [[XH_01_ViewController alloc]init];
