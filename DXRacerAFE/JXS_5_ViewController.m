...
@interface JXS_5_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation JXS_5_ViewController
...
- (void)viewDidLoad {
    ...
    [self.tableview registerNib:[UINib nibWithNibName:@"JXS_5_Cell" bundle:nil] forCellReuseIdentifier:@"cell"];    [self.view addSubview:self.tableview];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JXS_5_Cell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell];
    if (cell == nil) {
        cell = [[JXS_5_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifierCell];
    }
    ...
    cell.lab3.text = model.configDutymodel.chineseName;
    cell.lab4.text = model.qq;
    
    
    if (model.wechat == nil) {
        cell.lab5.text = @"-";
    }else{
        cell.lab5.text = model.wechat;
    }
    ...
    if (model.mobile == nil) {
        ...
        cell.lab7.text = model.mobile;
    }
    
    if (model.email == nil) {
        cell.lab8.text = @"-";
    }else{
        cell.lab8.text = model.email;
    }
...
- (void)clickadd{
    JXS_5_add_edit_ViewController *add = [[JXS_5_add_edit_ViewController alloc]init];
...
- (void)clickeditbtn:(UIButton *)sender{
    JXS_5_Cell *cell = (JXS_5_Cell *)[[sender.superview superview] superview];
    NSIndexPath *indexpath = [self.tableview indexPathForCell:cell];
    paymodel *model = [self.dataArray objectAtIndex:indexpath.row];
    
    JXS_5_add_edit_ViewController *edit = [[JXS_5_add_edit_ViewController alloc]init];
    ...
    edit.str3   = model.configDutymodel.chineseName;
    edit.str3id = model.configDutymodel.id;
...
- (void)clickdelebtn:(UIButton *)sender{
    ...
    [session POST:KURLNSString2(@"servlet", @"dealer/manager",@"dealercontact",@"delete") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
...
//                   NSLog(@"%@",dic);
        ...
        for (NSDictionary *dict in arr) {
            ...
            ConfigDutyModel *model2 = [ConfigDutyModel mj_objectWithKeyValues:model.configDuty];
            model.configDutymodel = model2;
