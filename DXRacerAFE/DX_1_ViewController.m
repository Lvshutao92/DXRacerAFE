...
-(void)clickadd{
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:@"请输入名称" preferredStyle:UIAlertControllerStyleAlert];
    //增加确定按钮；
...
- (void)clickedit:(UIButton *)sender{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:@"请输入数量" preferredStyle:UIAlertControllerStyleAlert];
    //增加确定按钮；
    [alertController addAction:[UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        UITextField *TextField1 = alertController.textFields.firstObject;
        UITextField *TextField2 = alertController.textFields[1];
