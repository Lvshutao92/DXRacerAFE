...
@interface XH_1_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation XH_1_ViewController
...
- (void)loddeList{
    ...
    [session POST:KURLNSString2(@"servlet", @"order",@"manager",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
