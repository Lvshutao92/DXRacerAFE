...
-(void)reloadDataWith:(JXS_SH3model *)model
{
    [self.imageView_cell sd_setImageWithURL:[NSURL URLWithString:NSString(model.model4.picture)]placeholderImage:[UIImage imageNamed:@"bgview"]];
    
    self.nameLabel.text = model.model4.partNo;
    
    
    if ([model.model2.id isEqualToString:model.model3.fromCurrency]) {
        self.priceLabel.text = [NSString stringWithFormat:@"%@%.2f",model.model2.field1,[model.model4.aftersale_price floatValue]];
        ;
        self.dateLabel.text = [NSString stringWithFormat:@"%@%@",model.model2.field1,[NSString stringWithFormat:@"%.2lf",[model.model1.quantity floatValue]*[model.model4.aftersale_price floatValue]]];
    }else{
        self.priceLabel.text = [NSString stringWithFormat:@"%@%.2lf",model.model2.field1,[model.model4.aftersale_price floatValue]*[model.model3.rate floatValue]];
        ;
        self.dateLabel.text = [NSString stringWithFormat:@"%@%@",model.model2.field1,[NSString stringWithFormat:@"%.2lf",[model.model1.quantity floatValue]*[model.model4.aftersale_price floatValue]*[model.model3.rate floatValue]]];
    }
    ...
    self.numberLabel.text = [NSString stringWithFormat:@"%@",model.model1.quantity];
    
    
    self.sizeLabel.text = [NSString stringWithFormat:@"%.2lfkg",[model.model4.weight floatValue]*[model.model1.quantity floatValue]];
...
- (void)setupview {
    ...
    self.cutBtn.frame = CGRectMake(SCREEN_WIDTH-120, 60, 30, 30);
    ...
    self.numberLabel.frame = CGRectMake(SCREEN_WIDTH-90, 60, 50, 30);
