...
@interface XH_2_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation XH_2_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loddeList{
    ...
    [session POST:KURLNSString3(@"servlet", @"order",@"manager",@"confirm",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
