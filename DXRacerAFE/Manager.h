...
+ (NSString *)TimeCuoToTime_yh:(NSString *)str;
...
+ (NSString *)jinegeshi111:(NSString *)text;
...
@property(nonatomic,strong)NSString *gerenMax;
@property(nonatomic,strong)NSString *gerenMin;

@property(nonatomic,strong)NSString *piliangMax;
@property(nonatomic,strong)NSString *piliangMin;
