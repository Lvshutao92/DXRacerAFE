...
@interface configContainerModel : NSObject


@property(nonatomic, strong)NSString *businessId;
@property(nonatomic, strong)NSString *containerCapacity;
@property(nonatomic, strong)NSString *containerCode;
@property(nonatomic, strong)NSString *containerHeight;
@property(nonatomic, strong)NSString *containerLong;

@property(nonatomic, strong)NSString *containerWidth;
