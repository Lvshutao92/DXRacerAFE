//
//  FK_4_Details_TableViewController.m
//  DXRacerAFE
//
...
@interface FK_4_Details_TableViewController ()
@property(nonatomic, strong)NSMutableArray *dataArray;
@end

@implementation FK_4_Details_TableViewController
...
//        NSLog(@"----%@",dic);
                ...
                for (NSDictionary *dict in arr) {
                    FK_1_2_Details_Model *model = [FK_1_2_Details_Model mj_objectWithKeyValues:dict];
