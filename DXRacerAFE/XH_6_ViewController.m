...
#import "XH____TableViewCell.h"
@interface XH_6_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation XH_6_ViewController
...
- (void)viewDidLoad {
    ...
    [self.tableview registerNib:[UINib nibWithNibName:@"XH____TableViewCell" bundle:nil] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    XH____TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell];
    if (cell == nil) {
        cell = [[XH____TableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifierCell];
    }
...
- (void)loddeList{
    ...
    dic = @{@"businessId":[Manager redingwenjianming:@"businessId.text"],
            ...
            @"orderStatus":@"undelivery",
            };
    
    [session POST:KURLNSString3(@"servlet", @"order",@"manager",@"delivery",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
