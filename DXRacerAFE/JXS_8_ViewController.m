...
@interface JXS_8_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation JXS_8_ViewController
...
- (void)viewDidLoad {
    ...
    [self.tableview registerNib:[UINib nibWithNibName:@"JXS_8_Cell" bundle:nil] forCellReuseIdentifier:@"cell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JXS_8_Cell *cell = [tableView dequeueReusableCellWithIdentifier:identifierCell];
    if (cell == nil) {
        cell = [[JXS_8_Cell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifierCell];
    }
    ...
    cell.lab2.text = model.model2.logisticName;
    
    cell.lab3.text = model.person;
    cell.lab4.text = model.mobile;
    cell.lab5.text = model.telephone;
    cell.lab6.text = model.truckNumber;
...
- (void)clickadd{
    JXS_8_Add_Edit_ViewController *add = [[JXS_8_Add_Edit_ViewController alloc]init];
...
- (void)clickeditbtn:(UIButton *)sender{
    JXS_8_Cell *cell = (JXS_8_Cell *)[[sender.superview superview] superview];
    NSIndexPath *indexpath = [self.tableview indexPathForCell:cell];
    JXS_8_model *model = [self.dataArray objectAtIndex:indexpath.row];
    
    JXS_8_Add_Edit_ViewController *edit = [[JXS_8_Add_Edit_ViewController alloc]init];
    ...
    edit.str2   = model.model2.logisticName;
    edit.str2id = model.model2.id;
    
    edit.str3   = model.person;
    edit.str4   = model.mobile;
    edit.str5   = model.telephone;
    edit.str6   = model.truckNumber;
...
- (void)clickdelebtn:(UIButton *)sender{
    ...
    [session POST:KURLNSString2(@"servlet", @"dealer/manager",@"dealerlogistic",@"delete") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
...
- (void)loddeList{
    ...
    [session POST:KURLNSString2(@"servlet", @"dealer/manager",@"dealerlogistic",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
    } success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSDictionary *dic = [Manager returndictiondata:responseObject];
...
//        NSLog(@"%@",dic);
        ...
        for (NSDictionary *dict in arr) {
            ...
            configLogisticmodel *model2 = [configLogisticmodel mj_objectWithKeyValues:model.configLogistic];
            model.model2 = model2;
