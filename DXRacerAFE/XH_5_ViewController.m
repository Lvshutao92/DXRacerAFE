...
@interface XH_5_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation XH_5_ViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loddeList{
    ...
    [session POST:KURLNSString3(@"servlet", @"order",@"manager",@"canceled",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
