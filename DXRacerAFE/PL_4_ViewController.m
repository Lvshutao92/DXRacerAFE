...
@interface PL_4_ViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger totalnum;
    NSInteger page;
}
...
@implementation PL_4_ViewController
...
- (void)loddeList{
    ...
    [session POST:KURLNSString3(@"servlet", @"order",@"manager",@"production",@"list") parameters:dic constructingBodyWithBlock:nil progress:^(NSProgress * _Nonnull uploadProgress) {
